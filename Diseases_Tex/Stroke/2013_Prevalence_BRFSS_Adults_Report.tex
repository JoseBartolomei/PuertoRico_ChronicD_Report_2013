...
\item The Stroke prevalence for the year 2013 among adults in Puerto Rico was 1.95 (1.57-2.32) percent, representing an estimate of 54,904 individuals that have been told they have had a stroke at some point in their life, Table \ref{tab:Overall.tabl.Stroke.2013}.
...
\item Adults in the age group of 55-64, and 65+ had 6.03, and 7.7 times higher likelihood, respectively, of reporting stroke when compared with the 24-35 group. This differences were significant (p-value $<$ 0.05). See Table \ref{tab:age.reduced}. The 18-24 age group was excluded from the regression analysis because it does not had cases. The original six group information is at table \ref{tab:age.Stroke.2013}.
...
~~25-34&0.38&  1,870&1.00&0.00&1.00\tabularnewline
~~35-44&1.2&  5,800&2.99&0.83&0.19\tabularnewline
~~45-54&1.31&  6,317&2.17&0.83&0.35\tabularnewline
~~55-64&3.96& 17,338&6.03&0.85&0.03\tabularnewline
~~65+&4.32& 23,579&7.7&0.90&0.02\tabularnewline
\hline
\end{tabular}\end{center}
...
\item Among adults, females had a 15\% lower likelihood of reporting a stroke compared to males. This difference was not significant (p-value $>$ 0.05). See Table \ref{tab:sex.Stroke.2013}.

\end{itemize}

\begin{figure}[H]
\caption{Stroke prevalence among adults by gender, 
2013}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{table}[H]
\caption{Stroke prevalence  among adults by gender, 2013\label{tab:sex.Stroke.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
\item When comparing education level, those with Some High School have the highest stroke prevalence reported to be 2\%.
(Figure \ref{fig:edu.Stroke.2013}).

\item 
When observing the adjusted odds ratio, the group Some University had 11\% lower likelihood of reporting stroke than the reference group (Some High School).
This difference was not significant (p-value $>$ 0.05).  Data is shown in Table \ref{tab:edu.Stroke.2013}.

\end{itemize}

\begin{figure}[H]
\caption{Stroke prevalence among adults by education level, 
         2013}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{table}[H]
\caption{Stroke prevalence among adults by education level, 2013\label{tab:edu.Stroke.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
\item Figure \ref{fig:income.Stroke.2013} shows that adults whose annual household income is $<$\$15k had higher stroke prevalence than those in other income groups.

\item Those in the \$35k-$<$50k income range had a 53\% lower likelihood of reporting stroke than those whose annual income wass less than \$14,999. This difference was not significant (p-value $>$ 0.05).  For further information, refer to Table \ref{tab:income.Stroke.2013}.

\end{itemize}

\begin{figure}[H]
\caption{Stroke prevalence among adults by household income level, 
         2013}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{table}[H]
\caption{Stroke prevalence  among adults by income level, 2013\label{tab:income.Stroke.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
\item Adults who reported being a Widowed at the time of the interview had the highest stroke prevalence among all marital status groups. Refer to figure \ref{fig:marital.Stroke.2013}.

\item Those who were separated had 77\% lower likelihood of having a stroke compared to those who reported being Married. This difference was significant (p-value $<$ 0.05). Refer to Table \ref{tab:marital.Stroke.2013}.
...
\item Adults who reported being unable to work at the time of the interview had the highest stroke prevalence (Figure \ref{fig:employ.Stroke.2013}).

\item Adults who reported being unable to work had 5.5 times more likely to report a stroke compared to those who reported being employed. This difference was significant (p-value $<$ 0.05). Data is shown in Table \ref{tab:employ.Stroke.2013}.
...
\item Figure \ref{fig:fairpoor.Stroke.2013} shows that stroke prevalence was significantly
\ifthenelse{
 83 < 
  399}{higher}{lower} in persons who perceive their health has fair / poor,
than those who claim to have a very good health.

\item Adults who perceived their health as fair or poor had a 5\% lower likelihood of reporting stroke compared to those who perceived their health as very good. This difference was not significant (p-value $>$ 0.05). Data is shown in Table \ref{tab:fairpoor.Stroke.2013}.
...
\item The group of adults who reported being physically unhealthy for 14 days or more in the past 30 days had a  
\ifthenelse{
 152 >
  432}{lower}{higher} stroke prevalence compared to those who reported being physically unhealthy for less than 13 days in the last 30 days.

%\item Table \ref{tab:phys} shows the estimations of the set_Measure.

\item Adults who felt physically impaired for 14 or more days had a 4\% lower likelihood of reporting having stroke at the time of the interview compared to those who felt physically unhealthy for 13 days or less (See Table \ref{tab:phys.Stroke.2013}).
...
\item Stroke prevalence among adults who reported feeling mentally unhealthy for 14 or more days in the last month was \ifthenelse{177 > 
  288}{lower}{higher} compared to those who reported feeling mentally unhealthy for less than 14 days (Figure \ref{fig:mental.Stroke.2013}).
...
\item A \ifthenelse{
 227 > 
  397}{lower}{higher} 
stroke prevalence was observed among adults who were unable to perform their usual activities for 14 or more days due to physical or mental impairment compared to those reportig less than 14 days. Refer to Figure \ref{fig:poor.Stroke.2013}.


\item Persons who could not conduct their usual daily activities for more than 14 days in the last month were 55\% less likely to report a stroke compared to those who felt this way for at most 13 days in the last 30 days. The difference was not significant (p $>$ 0.05).
...
\begin{table}[H]
\caption{Stroke prevalence among adults who were unable to conduct usual activities due to physical or mental impairment, 2013\label{tab:poor.Stroke.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
\item As seen in Figure \ref{fig:unhlthy.Stroke.2013}, those adults who felt mentally or physically unhealthy for more than 14 days in the last 30 days had a \ifthenelse{
1>
3}{lower}{higher} 
stroke prevalence than those reporting less than 14 days.
...
In 2013 an estimated 54,904 (1.95\%) adults in Puerto Rico reported being told by a health professional they have had an stroke at any point in their life.  Due to the small number of cases, statistically speaking, of stroke among adults in Puerto Rico the statistical power to perform hypothesis testing and confidence interval is limited.  As seen in the result sections the confidence intervals are very wide and almost no test resulted in a significant one.  Two options are available to solve this issue. First, the BRFSS office can, if funds are available, increase the survey sample size. Second, increase the sample size by aggregating three survey years.  In this manner is possible to increase the certainty of the estimates.

The age groups of 55-64 and 65+ had a significant higher prevalence and risk than the other age groups. With regards to gender, education and income the differences in the stroke prevalence and risk were not statistically significant.  Nonetheless, as with other chronic diseases with lower income and lower education the prevalence and risk are higher.  With regards the employment analysis the Unable to Work group had a meaningful difference when compare to the other employment groups. This group had almost six time more risk than the employed which were the reference group.

Moving to the health related quality of life measures, the adults that perceived their health as fair or poor had significantly higher prevalence than those who considered their health as good, very good or excellent.  Nevertheless, the risk was not different. As the previous HRQOL measure the adults who said that they felt physically unhealthy for 14 days or more for the last 30 days had significant higher prevalence of reporting stroke than those who felt physically unhealthy less than 13 days. Nonetheless, the risk was the same. .........
