...
%latex.default(tabl.sex, title = "Variables", file = "", append = TRUE,     rgroup = "Sex group", colhead = c("Prevalence", "Cases (N)",         "OR", "OR(SE)", "p-value"), longtable = F, table.env = T,     here = T, caption = paste(set_Measure, " among adults by gender,",         set_Years, sep = " "), label = paste("tab:sex", set_DiseaseF,         set_Years, sep = "."))%
\begin{table}[H]
...
\item Figure \ref{fig:income.Heart_Attack.2013} shows that adults whose annual household income is $<$\$15k had a higher a heart attack prevalence than those in other income groups.

\item Those in the $50+k income range had a 50\% lower likelihood of reporting heart attack than those whose annual income was less than \$14,999. This difference was not significant (p-value $>$ 0.05).  For further information, refer to Table \ref{tab:income.Heart_Attack.2013}.
...
\ifthenelse{
 219 < 
  973}{higher}{lower} in persons who perceive their health as fair / poor than those who claim to be excellent / very good.
...
\ifthenelse{
 414 >
  901}{lower}{higher} heart attack prevalence compared with to those who reported being physically unhealthy for less than 13 days in the last 30 days.
...
\item Heart attack prevalence among adults who reported feeling mentally unhealthy for 14 days or more in the last month was, non significantly, \ifthenelse{471 > 
  601}{lower}{higher} than those who reported feeling mentally unhealthy for less than 14 days (Figure \ref{fig:mental.Heart_Attack.2013}).
...
\item As seen in Figure \ref{fig:unhlthy.Heart_Attack.2013}, those adults who felt mentally or physically unhealthy for more than 14 days in the last 30 days had a \ifthenelse{
4>
7}{lower}{higher} 
