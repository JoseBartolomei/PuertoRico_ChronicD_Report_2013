...
\item Figure \ref{fig:age.Diabetes.2013} shows that the diabetes prevalence for the age group of 65+ was significantly higher compared to the other groups. \ref{tab:age.Diabetes.2013}

\item Adults in the age group of 35-44, 45-54, 55-64, and 65+ had 5.94, 9.49, 14.9, and 20.3 times higher possibility, respectively, of reporting diabetes prevalence when compared with the 18-24 group. Those differences were significant (p-value $<$ 0.05). See Table \ref{tab:age.Diabetes.2013}.
...
diabetes prevalence compared to females.
...
\item Among adults, females had a 3\% lower likelihood of reporting diabetes prevalence compared to males. This difference was not significant (p-value $>$ 0.05). See Table \ref{tab:sex.Diabetes.2013}.

\end{itemize}

\begin{figure}[H]
\caption{Diabetes prevalence among adults by gender, 
2013}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{table}[H]
\caption{Diabetes prevalence among adults by gender, 2013\label{tab:sex.Diabetes.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
\item When comparing education level, those with Some High School have the highest and significant diabetes prevalence compared to the other education groups. The diabetes prevalence among the Some High School groups reported to be 25 percent.
(Figure \ref{fig:edu.Diabetes.2013}).

\item 
When observing the adjusted odds ratio, the group University Graduate had 37\% lower likelihood of reporting diabetes than the reference group (Some High School).
This difference was significant (p-value $<$ 0.05).  Data is shown in Table \ref{tab:edu.Diabetes.2013}.

\end{itemize}

\begin{figure}[H]
\caption{Diabetes prevalence among adults by education level, 
         2013}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{table}[H]
\caption{Diabetes prevalence  among adults by education level, 2013\label{tab:edu.Diabetes.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
$<$15k had a diabetes prevalence higher than those in other income groups.

\item Those in the range of 50+k had 34\% lower possibility of reporting diabetes than those whose annual income was less than \$14,999. This difference was marginally significant (p-value $>$ 0.05).  For further information, refer to Table \ref{tab:income.Diabetes.2013}.

\end{itemize}

\begin{figure}[H]
\caption{Diabetes prevalence among adults by household income level, 
         2013}
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}
...
\begin{table}[H]
\caption{Diabetes prevalence  among adults by income level, 2013\label{tab:income.Diabetes.2013}} 
\begin{center}
\begin{tabular}{llllll}
\hline\hline
\multicolumn{1}{l}{Variables}&\multicolumn{1}{c}{Prevalence}&\multicolumn{1}{c}{Cases (N)}&\multicolumn{1}{c}{OR}&\multicolumn{1}{c}{OR(SE)}&\multicolumn{1}{c}{p-value}\tabularnewline
...
\item Adults who reported being a Widowed at the time of the interview, had the highest diabetes prevalence among all marital status groups. Refer to figure \ref{fig:marital.Diabetes.2013}.

\item Those who were Separated had a 53\% lower possibility of having diabetes compared to those who reported being Married. This difference was significant (p-value $<$ 0.05). Refer to Table \ref{tab:marital.Diabetes.2013}.
...
\item Adults who reported being retired at the time of the interview had the highest diabetes prevalence (Figure \ref{fig:employ.Diabetes.2013}).

\item Adults who work at home, retired, or unable to work were 1.97, 2.06, and 2.27 times more likely, respectively, to report having diabetes compared to those who responded being employed. The differences were significant (p-value $<$ 0.05). 
Data is shown in Table \ref{tab:employ.Diabetes.2013}.
...
\item Figure \ref{fig:fairpoor.Diabetes.2013} shows that diabetes prevalence is
\ifthenelse{
 706 < 
  2901}{higher}{lower} in persons who perceive their health as fair / poor,
than those who claim to have be excellent/very good.

\item Adults who perceived their health as fair or poor had a 11\% lower likelihood of reporting having diabetes compared to those who perceived their health as very good. This difference was not significant (p-value $>$ 0.05). Data is shown in Table \ref{tab:fairpoor.Diabetes.2013}.
...
\ifthenelse{
 1284 >
  2654}{lower}{higher} diabetes prevalence compared to 
...
\item Adults who felt physically impaired for 14 or more days had a, non-significant, 8\% lower likelihood of reporting having diabetes at the time of the interview compared to those who felt physically impaired for 13 days or less (See Table \ref{tab:phys.Diabetes.2013}).
...
\item Diabetes prevalence among adults who reported feeling mentally unhealthy for 14 days or more than in the last month was \ifthenelse{1435 > 
  1803}{lower}{higher} than those who reported feeling mentally unhealthy for less than 14 days (Figure \ref{fig:mental.Diabetes.2013}).

%\item set_Measure for this groups are presented in the Table \ref{tab:mental}.

\item  Adults who felt mentally unhealthy for 14 or more days had 40\% lower likelihood of having diabetes compared to those who answered 0-13 days. This difference was not significant (p-value $>$ 0.05). (See Table \ref{tab:mental.Diabetes.2013}).
...
\item A \ifthenelse{
 1490 > 
  2399}{lower}{higher} 
diabetes prevalence was observed among adults who were unable to perform their usual activities for 14 or more days due to physical or mental impairment compared to those reporting less than 14 days. Refer to Figure \ref{fig:poor.Diabetes.2013}.

\item Persons who could not conduct their usual daily activities for more than 14 days in the last month were 6\% less likely to report diabetes compared to those who felt this way for at most 13 days in the last 30. The difference was not statistically significant (p $<$ 0.05).
...
\item As seen in Figure \ref{fig:unhlthy.Diabetes.2013}, those adults who felt mentally or physically unhealthy for more than 14 days in the last 30 days had a \ifthenelse{
13>
20}{lower}{higher} 
diabetes prevalence than those reporting less than 14 days.
...
\item Those persons who felt mentally or physically unhealthy for more than 14 days in the last month were 22\% less likely to report having diabetes compared to those who felt mentally or physically unhealthy for at most 13 days in the last 30 days. Data shown in Table \ref{tab:unhlthy.Diabetes.2013}.
...
An estimated 418,229 (14.88\%) adult in Puerto Rico had diabetes in the 2013 period.
When evaluating diabetes by age groups we observe a strong increase in diabetes prevalence with an increase in age group. The 65+ age group have 20 times more likelihood of reporting diabetes when compared with the 18-24 age group. Was estimated that about 200,000 individuals age 65 or more reported having the condition. With regards to gender and diabetes there was not a statistical nor meaningful differences in prevalence or risk.  Those in the education group of Some University or University Graduates had significantly less likelihood to report being diagnose with diabetes compared to the Some High School group.  Although marginally significant those in the household income range of 35k-50k and those in the range of more than 50k annually were less likely to report being diagnose with diabetes than those in the group of less than 15k annually. In addition, was observed a constant decrease in prevalence form the less to most affluent group. Regarding marital status, the group that reported being separated had significant less risk to report diabetes than the Married group. Although the Widowed group had the higher prevalence the one who had the higher risk was the Never Married group. Nevertheless, the risk was not significant.  Those who reported being separated from their couple obtained a significant less risk of being told they had diabetes. Those who reported being in the group Work at Home, Retired, or Unable to Work had significantly higher risk to report being diagnose with diabetes.

Moving to the health related quality of life measures, the possibility of reporting diabetes prevalence in adults that perceived their health as fair or poor was 0.11 times lower than those who considered their health as good, very good or excellent. The adults who said that they felt physically bad for 14 or more days for the last 30 days had 0.08 times lower likelihood to report diabetes prevalence than those less than 13 days. In the same manner, adults who felt mentally distressed for 14 days or more in a month had 0.4 times lower possibility to report diabetes than those feeling mentally distressed less than 13 days. The adults who were unable to carry on with their normal activities more than 14 days in a month had 0.06 less risk than the comparison group. Non of the health related quality of life comparisons were statistically nor meaningfully significant. The results of HRQOL showed that there was no statistical association between the poor side of the related quality of measures and having diabetes.
